...
# st.title("📄Prompt Pages")
# st.caption("Your AI-powered documentation companion")
...
#     with col1:
#         doc_url = st.text_input("Paste documentation URL", placeholder="https://example.com/docs/...", label_visibility="collapsed")
#     with col2:
...
#     user_prompt = st.text_input("Your question", placeholder="What does this API do?", key=f"query_{len(st.session_state.query_history)}")
...
# # Show Q&A history with styled containers
...
#         with st.container():  # Outer container for Q&A pair

#             # Question box - dark blue with white text
#             st.markdown(
#                 f"""
#                 <div style='
...
#             # Answer box - light with black textfdfdfd
#             # st.markdown(
#             #     f"""
#             #     <div style='
#             #         background-color:#1f77b4;
...
#             #             {st.markdown(q['answer'], unsafe_allow_html=False)}
#             #         </div>
#             #     </div>
#             #     """,
#             #     unsafe_allow_html=True
#             # )
#             st.markdown("<br>", unsafe_allow_html=True)  # Spacing between entries
